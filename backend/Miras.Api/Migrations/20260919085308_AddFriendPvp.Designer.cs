...
namespace Miras.Api.Migrations
{
    ...
    [Migration("20260919085308_AddFriendPvp")]
    partial class AddFriendPvp
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Miras.Api.Models.PvpMatch", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<string>("GuestCharacterId")
                        .HasMaxLength(50)
                        .HasColumnType("character varying(50)");

                    b.Property<string>("GuestMove")
                        .HasMaxLength(10)
                    ...
                    b.Property<string>("HostCharacterId")
                        .IsRequired()
                        .HasMaxLength(50)
                        .HasColumnType("character varying(50)");

                    b.Property<string>("HostMove")
                        .HasMaxLength(10)
                        .HasColumnType("character varying(10)");
                    ...
                    b.Property<string>("LastGuestMove")
                        .HasMaxLength(10)
                        .HasColumnType("character varying(10)");

                    b.Property<string>("LastHostMove")
                        .HasMaxLength(10)
                        .HasColumnType("character varying(10)");

                    b.Property<int?>("LastRoundWinnerId")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Miras.Api.Models.PvpMatch", b =>
                {
                    b.HasOne("Miras.Api.Models.User", "GuestUser")
                        .WithMany()
                        .HasForeignKey("GuestUserId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("Miras.Api.Models.User", "HostUser")
                        .WithMany()
                        .HasForeignKey("HostUserId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("Miras.Api.Models.User", "WinnerUser")
                        .WithMany()
