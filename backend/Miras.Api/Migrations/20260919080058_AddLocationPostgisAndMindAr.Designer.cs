...
namespace Miras.Api.Migrations
{
    ...
    [Migration("20260919080058_AddLocationPostgisAndMindAr")]
    partial class AddLocationPostgisAndMindAr
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Miras.Api.Models.Location", b =>
                {
                    ...
                    b.Property<string>("MindFileHash")
                        .HasColumnType("text")
                        .HasColumnName("mind_file_hash");

                    b.Property<string>("MindFilePath")
                        .HasColumnType("text")
                        .HasColumnName("mind_file_path");
                    ...
                    b.HasIndex("Position")
                        .HasDatabaseName("idx_locations_position");
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            EntityId = 1,
                            IsActive = true,
                            Latitude = 55.797199999999997,
                            Longitude = 49.149500000000003,
                            MindFilePath = "mind/shurale.mind",
                            Name = "Лесопарк Лебяжье",
                            NfcToken = "SHURALE_NFC",
                            Position = (NetTopologySuite.Geometries.Point)new NetTopologySuite.IO.WKTReader().Read("SRID=4326;POINT (49.1495 55.7972)")
                        },
                        new
                        {
                            Id = 2,
                            EntityId = 2,
                            IsActive = true,
                            Latitude = 55.779699999999998,
                            Longitude = 49.1235,
                            MindFilePath = "mind/su-anasy.mind",
                            Name = "Озеро Кабан",
                            NfcToken = "SUANASY_NFC",
                            Position = (NetTopologySuite.Geometries.Point)new NetTopologySuite.IO.WKTReader().Read("SRID=4326;POINT (49.1235 55.7797)")
                        },
                        new
                        {
                            Id = 3,
                            ...
                            Position = (NetTopologySuite.Geometries.Point)new NetTopologySuite.IO.WKTReader().Read("SRID=4326;POINT (49.1051 55.8005)")
                        },
                        new
                        {
                            Id = 4,
                            EntityId = 4,
                            IsActive = true,
                            Latitude = 55.798400000000001,
                            Longitude = 49.105200000000004,
                            MindFilePath = "mind/kereml.mind",
                            Name = "Казанский Кремль",
                            NfcToken = "ABC123",
                            Position = (NetTopologySuite.Geometries.Point)new NetTopologySuite.IO.WKTReader().Read("SRID=4326;POINT (49.1052 55.7984)")
                        });
                });
