...
- ИИ получает команду того же размера и меняет активного персонажа при низком здоровье или после поражения. Общий запас здоровья команды ИИ делится между бойцами, поэтому переключения не увеличивают сложность боя в несколько раз.
